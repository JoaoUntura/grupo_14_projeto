...
const gerenciar_produtos =require('./routers/gerenciar_produtos')
const gerenciar_clientes =require('./routers/gerenciar_clientes')
...
app.use('/gerenciar_produtos', gerenciar_produtos)
app.use('/gerenciar_clientes', gerenciar_clientes)
